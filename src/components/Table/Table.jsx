      ...
      <table className="w-full text-sm text-left rtl:text-right text-white">
        <tbody>
          <tr className="border-b border-blue-400">
            <td className="px-4 py-4 sm:px-2 md:px-2 min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-lg min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-lg md:text-2xl  font-bold  text-white border bg-yellow-200">
              <div className="flex flex-col items-center text-center">
                <span>Професійний вектор</span>
                <span id="destinyNumber">{fateNumber}</span>
              </div>
            </td>
            <td className="px-4 py-4 sm:px-2 md:px-2 whitespace-nowrap min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-lg md:text-2xl font-bold  text-white border bg-yellow-200">
              <div className="flex flex-col items-center">
                <span>Побут</span>
                <span id="everydayLife">{everyDayLifeNumber}</span>
              </div>
            </td>
            <td className="px-4 py-4 sm:px-2 md:px-2 whitespace-nowrap min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-lg md:text-2xl  font-bold bg-yellow-200 text-white border ">
              <div className="flex justify-between">
                <span></span>
                <span></span>
              </div>
            </td>
            <td className="px-4 py-4 sm:px-2 md:px-2  whitespace-nowrap min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-base md:text-2xl font-bold bg-yellow-200 text-white border">
              <div className="flex flex-col items-center">
          ...
          <tr className="border-b border-gray-200 dark:border-gray-700">
            ...
            <td className="px-4 py-4 sm:px-2 md:px-2 min-[320px]:px-2 min-[320px]:pl-1.5  sm:text-lg md:text-2xl bg-yellow-200 font-bold text-white whitespace-nowrap border">
              <div className="flex flex-col items-center">
                <span>Звички</span>
